var ctrl_DataGridDossierElt = app.controller('ctrlDataGridDossierElt',
  function($rootScope,$scope,$http,$compile) {
    ...
    function successPost(dataJson){
        ...
        var btnhtml = '<jsontabledossierelt data="data"></jsontabledossierelt> ';
        var temp = $compile(btnhtml)($scope);
        angular.element(document.getElementById('datasDossiersElt')).append(temp);
...
ctrl_DataGridDossierElt.filter('startFrom', function() {
...
ctrl_DataGridDossierElt.directive('jsontabledossierelt', function($rootScope,$timeout) {
	return {
		restrict : 'E',
		transclude : true,
		scope : {
		...
		templateUrl : 'jsonTableDossierElt.html',
