var ctrl_DataGridDossierAccord = app.controller('ctrlDataGridDossierAccord',
  function($rootScope,$scope,$http,$compile) {
    ...
    function successPost(dataJson){
        ...
        var btnhtml = '<jsontabledossieraccord data="data"></jsontabledossieraccord> ';
        var temp = $compile(btnhtml)($scope);
        angular.element(document.getElementById('datasDossiersAccord')).append(temp);
...
ctrl_DataGridDossierAccord.filter('startFrom', function() {
...
ctrl_DataGridDossierAccord.directive('jsontabledossieraccord', function($rootScope,$timeout) {
	return {
		restrict : 'E',
		transclude : true,
		scope : {
		...
		templateUrl : 'jsonTableDossierAccord.html',
