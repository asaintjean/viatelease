var ctrl_DataGridDossierRefus = app.controller('ctrlDataGridDossierRefus',
  function($rootScope,$scope,$http,$compile) {
    ...
    function successPost(dataJson){
        ...
        var btnhtml = '<jsontabledossierrefus data="data"></jsontabledossierrefus> ';
        var temp = $compile(btnhtml)($scope);
        angular.element(document.getElementById('datasDossiersRefus')).append(temp);
...
ctrl_DataGridDossierRefus.filter('startFrom', function() {
...
ctrl_DataGridDossierRefus.directive('jsontabledossierrefus', function($rootScope,$timeout) {
	return {
		restrict : 'E',
		transclude : true,
		scope : {
		...
		templateUrl : 'jsonTableDossierRefus.html',
